...
A [VI Package (VIP)](https://www.vipm.io/package/field_rnd_services_logger/) is available at [VIPM.io](https://www.vipm.io). The recommended installation instruction is to:
